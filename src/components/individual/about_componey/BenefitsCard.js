  ...
  return (
    <div className={styles["benefits-card"]}>
      ...
      <BenefitItem 
        ...
        description="With 10+ years of experience, DG FutureTech ensures expert IT solutions, guiding your business through technology's complexitie"
        />

<BenefitItem 
        icon="☁️"
        title="24/7/365 Support"
        description="We provide 24/7 support to keep your IT systems running smoothly with minimal downtime."
        />
      <BenefitItem 
        icon="🔒"
